          ...
          <Item className="spacing">
            <div>
              ...
              <p>
                ...
                themselves to a God who created us, and who loves us.
              </p>
              <p>
                The authority from which we speak is the Holy Bible (the Word of
                God)
              </p>
              <p>
                To go forward there are some premises that we must acknowledge:
              </p>
            </div>
            <Flex>
              ...
              <div className="spacing">
                <TextItem>
                  <h3 className="bold accent italics">
                    4. The world in which we live groans under the burden of
                    man’s tenure, and the world reflects the evil influences of
                    mankind.
                  </h3>
                  <p>
                ...
                <TextItem>
                  <h3 className="bold accent italics">
                    5. Mankind is not progressing upward, but is in a downward
            ...
            <Left>
              ...
              <p>
                ...
                things of the world less and less, and you will want to seek the
                Lord more and more. Please take upon yourself to read the Word
                of God, ask the Lord to lead you to find a bible believing
                fellowship. <br />
                Look for fellowships that have a dispensational view of Bible
